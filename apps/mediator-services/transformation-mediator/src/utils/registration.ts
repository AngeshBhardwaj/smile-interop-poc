...
export function registerWithOpenHIM(): Promise<void> {
  return new Promise((resolve, reject) => {
    ...
    logger.info({
      msg: 'Registering transformation mediator with OpenHIM',
    ...
    registerMediator(openhimConfig, mediatorConfig, (err: any) => {
      ...
      logger.info({
        msg: 'Transformation mediator registered successfully with OpenHIM',
        urn: mediatorConfig.urn,
...
export function unregisterFromOpenHIM(): void {
  logger.info({ msg: 'Unregistering transformation mediator from OpenHIM' });
