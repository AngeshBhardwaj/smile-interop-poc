/**
 * Configuration management for Finance Transformation Mediator
 */
...
export const config = {
  ...
  client: {
    name: process.env.CLIENT_NAME || 'Finance Accounting Client',
    endpoint: process.env.CLIENT_ENDPOINT || 'http://finance-client:3202/orders',
    timeout: parseInt(process.env.CLIENT_TIMEOUT || '5000', 10),
  },

  openhim: {
    apiURL: process.env.OPENHIM_API_URL || 'https://openhim-core:8080',
    username: process.env.OPENHIM_USERNAME || 'finance-mediator',
