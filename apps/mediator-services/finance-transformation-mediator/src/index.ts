/**
 * Finance Transformation Mediator - Main Entry Point
 *
 * OpenHIM mediator that transforms CloudEvents (orders) to Finance Details format
 * with pricing, tax, accounting, and payment information
 */
...
async function startServer() {
  try {
    ...
    logger.info('Starting Finance Transformation Mediator', {
      env: config.env,
      port: config.port,
    ...
    logger.info('Finance Transformation Mediator started successfully');
  } catch (error: any) {
