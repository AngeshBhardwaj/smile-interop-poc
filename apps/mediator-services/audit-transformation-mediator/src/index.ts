/**
 * Audit Transformation Mediator - Main Entry Point
 *
 * OpenHIM mediator that transforms CloudEvents (orders) to Audit Trail format
 * with compliance, history tracking, and accountability
 */
...
async function startServer() {
  try {
    ...
    logger.info('Starting Audit Transformation Mediator', {
      env: config.env,
      port: config.port,
    ...
    logger.info('Audit Transformation Mediator started successfully');
  } catch (error: any) {
