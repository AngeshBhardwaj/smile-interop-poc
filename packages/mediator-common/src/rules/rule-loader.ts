...
/**
 * Get rules directory from environment or default path
 * Each mediator service should set RULES_DIRECTORY in its environment
 */
function getRulesDirectory(): string {
  return process.env.RULES_DIRECTORY || './src/transformation-rules';
}
