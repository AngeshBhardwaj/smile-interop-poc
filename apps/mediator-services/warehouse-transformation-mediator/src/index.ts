/**
 * Warehouse Transformation Mediator - Main Entry Point
 *
 * OpenHIM mediator that transforms CloudEvents (orders) to Warehouse Summary format
 * with minimal fields for fulfillment, packing, and delivery
 */
...
async function startServer() {
  try {
    ...
    logger.info('Starting Warehouse Transformation Mediator', {
      env: config.env,
      port: config.port,
    ...
    logger.info('Warehouse Transformation Mediator started successfully');
  } catch (error: any) {
